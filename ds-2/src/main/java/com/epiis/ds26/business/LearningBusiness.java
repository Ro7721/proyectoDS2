...
public class LearningBusiness {
    ...
    public CourseContentResponse getCourseContent(String idCourse, GenericResponse response) {
        ...
        if (enrollment == null) {
            response.error();
            response.listMessage.add("No estÃ¡s inscrito en este curso");
            return null;
        }
    ...
    public CourseProgressResponse saveProgress(LessonProgressRequest request, GenericResponse response) {
        ...
        if (request.getIdLesson() == null || request.getIdLesson().trim().isEmpty()) {
            response.warning();
            response.listMessage.add("El id de la lecciÃ³n es requerido");
            return null;
        }
        ...
        if (enrollment == null) {
            response.error();
            response.listMessage.add("No estÃ¡s inscrito en el curso de esta lecciÃ³n");
            return null;
        }
