...
export class AdminCategoriesComponent implements OnInit {
  ...
  getCategoryIcon(name: string | undefined): string {
    const icons: Record<string, string> = {
      ...
      'desarrollo deソフトウェア': 'pi-code',
      'desarrollo web': 'pi-code',
      'desarrollo móvil': 'pi-code',
      'desarrollo de juegos': 'pi-code',
      'bases de datos': 'pi-database',
      'inteligencia artificial': 'pi-robot',
      'machine learning': 'pi-brain',
      'big data': 'pi-server',
      'ciencias de datos': 'pi-chart-line',
      'arquitectura de software': 'pi-sitemap',
      'seguridad informática': 'pi-lock',
      'administración de sistemas': 'pi-cog',
      'tecnologías en la nube': 'pi-cloud',
      'programación en python': 'pi-python',
      'programación en java': 'pi-java',
      'programación en javascript': 'pi-javascript',
      'programación en c++': 'pi-cpp',
      'programación en c#': 'pi-csharp',
      'diseño gráfico': 'pi-paint-brush',
      'diseño de interfaz': 'pi-mobile',
      'diseño de experiencia': 'pi-users',
      'diseño web': 'pi-desktop',
      'edición de video': 'pi-video',
      'animación 3d': 'pi-box',
      'fotografía digital': 'pi-image',
      'modelado 3d': 'pi-box',
      'UX': 'pi-users',
      'UI': 'pi-desktop',
      'marketing digital': 'pi-megaphone',
      'marketing en redes sociales': 'pi-comments',
      'SEO': 'pi-search',
      'marketing de contenidos': 'pi-file-edit',
      'publicidad en línea': 'pi-dollar',
      'email marketing': 'pi-envelope',
      'marketing analítico': 'pi-chart-bar',
      'estrategia de marketing': 'pi-map',
      'gestión de ventas': 'pi-wallet',
      'ventas en línea': 'pi-shopping-cart',
      'negocios internacionales': 'pi-globe',
      'finanzas corporativas': 'pi-chart-line',
      'análisis financiero': 'pi-calculator',
      'gestión de proyectos': 'pi-project-diagram',
      'liderazgo': 'pi-user-edit',
      'gestión de equipos': 'pi-users',
      'recursos humanos': 'pi-user',
      'emprendimiento': 'pi-lightbulb',
      'negocios digitales': 'pi-wifi',
      'música electrónica': 'pi-music',
      'producción musical': 'pi-sliders-h',
      'teoría musical': 'pi-music',
      'guitarra': 'pi-guitar',
      'piano': 'pi-keyboard',
      'canto': 'pi-microphone',
      'DJ': 'pi-sliders-h',
      'edición de audio': 'pi-volume-off',
      'lengua española': 'pi-language',
      'inglés': 'pi-language',
      'francés': 'pi-language',
      'portugués': 'pi-language',
      'chino': 'pi-language',
      'japonés': 'pi-language',
      'alemán': 'pi-language',
      'italiano': 'pi-language',
      'fotografía callejera': 'pi-camera',
      'fotografía de retratos': 'pi-user',
      'fotografía de paisajes': 'pi-image',
      'fotografía de producto': 'pi-box',
      'fotografía de moda': 'pi-camera',
      'edición de fotografías': 'pi-image',
      'cálculo': 'pi-calculator',
      'álgebra': 'pi-calculator',
      'estadística': 'pi-chart-bar',
      'física cuántica': 'pi-atom',
      'astronomía': 'pi-satellite',
      'biología': 'pi-dna',
      'química': 'pi-flask',
      'geología': 'pi-mountain',
      'economía': 'pi-dollar',
    };
